...
void Skybox::BindEnvironmentCubeMap() {
...
void Skybox::captureEquirectangularToCubeMap() {
    ...
    equirectangularToCubemapShader.setMatrix4("captureProjection", captureProjection);
    glActiveTexture(GL_TEXTURE0);
    ...
    for (unsigned int i = 0; i < 6; ++i) {
        equirectangularToCubemapShader.setMatrix4("captureView", captureViews[i]);
